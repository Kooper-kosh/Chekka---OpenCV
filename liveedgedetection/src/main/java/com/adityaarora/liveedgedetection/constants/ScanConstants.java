...
public class ScanConstants {
    ...
    public static final int CANNY_THRESH_L = 85; //85
    public static final int CANNY_THRESH_U = 185; //185
    public static final int TRUNC_THRESH = 150; //dating 150
    public static final int CUTOFF_THRESH = 155; //255
}
